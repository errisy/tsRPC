...
namespace ts {
    ...
    */
    ...
    export function forEachExpectedEmitFile(host: EmitHost,
        ...
        tscDebugger.enter('forEachExpectedEmitFile');
        const options = host.getCompilerOptions();
        ...
        function onSingleFileEmit(host: EmitHost, sourceFile: SourceFile) {
            ...
            tscDebugger.enter('onSingleFileEmit');
            if (sourceFile.fileName) tscDebugger.comment(sourceFile.fileName);
            let extension = ".js";
            ...
            tscDebugger.exit('onSingleFileEmit');
        }
        ...
        tscDebugger.exit('forEachExpectedEmitFile');
    }
